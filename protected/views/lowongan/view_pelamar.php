...
<h2><i class="fa fa-bullhorn"></i> Lihat Lowongan #<?php echo $model->id_lowongan; ?></h2>
<div class="x_title">
                    </div>
...
<div class="row">
        <div class="col-md-12">
            <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
            	<a class="btn btn-primary" onclick="location='<?= Yii::app()->request->baseUrl; ?>/index.php/lowongan/'"><span class="glyphicon glyphicon-arrow-left"></span>  Kembali</a>
<br><br>    
                ...
                <div class="profile_img">
                            ...
                            <?php
                            //Lakukan pengecekan apakah pelamar sudah pernah melamar
                            $cek = Lamaran::model()->cekPengajuan(Yii::app()->session->get('id_pelamar'), $model->id_lowongan);
                            foreach ($cek as $hasil) {
                                if($hasil['jumlah_lamaran']>0){
                                    ?>
                                        <a disabled title="Lamaran hanya dapat diajukan 1x" class="btn btn-warning   col-md-12" href="#"><i class="fa fa-remove"></i> Lamaran telah diajukan</a>
                                        <a title="Lamaran hanya dapat diajukan 1x" class="btn btn-info   col-md-12" href="<?= Yii::app()->request->baseUrl ?>/index.php/lamaran/lamaranSaya">Lihat lamaran saya</a>
                                    <?php
                                } else {
                                    ?>
                                        <a title="Ajukan lamaran sekarang" class="btn btn-warning col-md-12" href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/lamaran/pengajuan/<?= $model->id_lowongan; ?>"><i class="fa fa-pencil-square-o"></i> Ajukan Lamaran</a>
                                    <?php
                                }
                            }
                            ?>
