...
<h2><i class="fa fa-map-marker"></i> Lihat Kategori #<?php echo $model->id_kategori; ?></h2>
<div class="x_title">
                    </div>
...
<br><br>    
                ...
                <div class="profile_img">
                                <div id="crop-avatar">
                                    <!-- Current avatar -->
                                    <img class="img-responsive avatar-view" src="<?php echo Yii::app()->request->baseUrl; ?>/images/<?php echo $model->nama_kategori; ?>" alt="Avatar" title="<?php ?>">
                                </div>
                            </div>
                            <h3><?php ?></h3>
                        ...
                        <a title="Edit Kategori" class="btn btn-warning col-md-12" href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/kategori/update/<?= $model->id_kategori; ?>"><i class="fa fa-pencil"></i> Update Data</a>
                        <a onclick="return confirm('Anda yakin ingin menghapus <?php echo $model->nama_kategori;?>? Semua Lowongan dengan kategori <?php echo $model->nama_kategori;?> juga ikut terhapus')" title="Hapus Kategori" class="btn btn-danger col-md-12" href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/kategori/delete/<?= $model->id_kategori; ?>"><i class="fa fa-trash"></i> Hapus Data</a>
                        </div>
<br>
<br>
<br>
