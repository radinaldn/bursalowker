...
<div class="row">
		<div class="col-md-12">
			...
			<!-- <div class="panel"> -->
				<div class="">
					<div class="col-md-6">
					<h3><i class="fa fa-table"></i> Kategori <small> Bursa-Lowker </small></h3>
				</div>
								...
								<?php foreach ($model as $data) : ?>
									...
									<tr>
										...
										<!--<div class="hidden-sm hidden-xs action-buttons">-->
											...
											<a class="btn btn-danger btn-xs" href="delete/<?= $data->id_kategori; ?>" role="button"  onclick="return confirm('Anda yakin ingin menghapus <?php echo $data->nama_kategori;?>? Semua Lowongan kategori <?php echo $data->nama_kategori;?> juga ikut terhapus')"><i class="fa fa-trash"></i></a>
											<!--</div>-->
