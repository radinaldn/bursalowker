...
<p class="note">Form dengan tanda <span class="required">*</span> wajib diisi.</p>
  ...
  <!-- <div class="form-group">
    ...
    <div class="col-sm-9">
    <a target="_blank" href="<?php echo Yii::app()->request->baseUrl; ?>/files/<?php echo $model->lampiran; ?>"><button class="btn btn-success btn-xs"><i class="fa fa-download"></i>
  ...
  <div class="form-group">
 <label class="col-sm-3 controll-label no-padding-right" for="form-field-1">Status Lamaran *</label>
 <div class="col-sm-9">
