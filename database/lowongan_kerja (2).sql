...
CREATE TABLE `tb_kabkota` (
  `id_kabkota` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
...
--
ALTER TABLE `tb_kabkota`
  ADD CONSTRAINT `tb_kabkota_ibfk_1` FOREIGN KEY (`id_provinsi`) REFERENCES `tb_provinsi` (`id_provinsi`) ON DELETE CASCADE ON UPDATE CASCADE;
